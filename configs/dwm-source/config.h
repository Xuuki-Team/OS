...
static const char dmenufont[]       = "monospace:size=12", "Symbols Nerd Font:size=12";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { "#000100", "#ffffff", "#ffffff" },
...
/* layout(s) */
static const float mfact     = 0.55; /* factor of master area size [0.15..0.85] */
